...
int main()
{
    ...
    reg_httpServer_webContent("style.css", style_css);
    //reg_httpServer_webContent("efo_logo", efo_logo);
    // reg_httpServer_webContent("test1.html", test3_page);
    // reg_httpServer_webContent("favicon.ico", images_icon);
